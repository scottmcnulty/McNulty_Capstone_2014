...
public class ApplicationView extends JFrame {
	...
	public ApplicationView(final AnalyzerController analyzer){
		...
		setTitle("Harmonius"); 
		setSize(800,600);  //find out projector size
		...
		jp2.setLayout(new GridLayout(0,3,20,20));
		JLabel label2 = new JLabel();
		label2.setText("Pitch Warm Up Training");
		label2.setBorder(raisedetched);
	...
	//buttons for jp2
	JButton startbutton_jp2 = new JButton("Start");
	startbutton_jp2.addActionListener(new ActionListener() {
		public void actionPerformed(ActionEvent e) {	
			analyzer.startAction();
		}
	});
	jp2.add(startbutton_jp2, BorderLayout.WEST);
	
	
	JButton stopbutton_jp2 = new JButton("stop");
	stopbutton_jp2.addActionListener(new ActionListener() {
		public void actionPerformed(ActionEvent e) {
			//String result = Double.toString(analyzer.stopAction());
			analyzer.stopAction();
			//jp2ResultsJTextArea.setText(result);
		}
	});
	jp2.add(stopbutton_jp2, BorderLayout.EAST);
	
	//buttons for jp3
	JButton startbutton_jp3 = new JButton("Start");
	startbutton_jp3.addActionListener(new ActionListener() {
		public void actionPerformed(ActionEvent e) {	
			analyzer.startAction();
		}
	});
	jp3.add(startbutton_jp3);
	
	
	JButton stopbutton_jp3 = new JButton("stop");
	stopbutton_jp3.addActionListener(new ActionListener() {
		public void actionPerformed(ActionEvent e) {
			analyzer.stopAction();
		}
	});
	jp3.add(stopbutton_jp3);
